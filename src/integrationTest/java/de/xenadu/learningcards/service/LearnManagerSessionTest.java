...
@QuarkusTest
public class LearnManagerSessionTest {
    ...
    void setUp() {
        ...
        learnSessionManager = new LearnSessionManager(cardService, cardDistributor);
    }
    ...
    void whenACorrectConfigIsGiven_ExpectNewCardsAsGivenAndCardsForRepetitionWhichAreReadyForRepetition() {
        ...
        assertThat(learnSession.getNextCard().getFront()).contains("new");
        assertThat(learnSession.getNextCard().getFront()).contains("new");
        assertThat(learnSession.getNextCard().getFront()).contains("rep 1/");
        assertThat(learnSession.getNextCard().getFront()).contains("rep 3/").doesNotContain("(not in)");
        assertThat(learnSession.getNextCard().getFront()).contains("rep 3/").doesNotContain("(not in)");
        assertThat(learnSession.getNextCard().getFront()).contains("rep 5/");
    }
